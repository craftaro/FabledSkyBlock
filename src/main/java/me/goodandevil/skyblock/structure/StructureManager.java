		...
		if (configLoad.getString("Structures") != null) {
			for (String structureList : configLoad.getConfigurationSection("Structures").getKeys(false)) {
				...
				if (configLoad.getString("Structures." + structureList + ".Item.Material") == null) {
					...
					materials = Materials.fromString(configLoad.getString("Structures." + structureList + ".Item.Material"));
				...
				structureStorage.add(new Structure(configLoad.getString("Structures." + structureList + ".Name"), materials, configLoad.getString("Structures." + structureList + ".File"), configLoad.getString("Structures." + structureList + ".Displayname"), configLoad.getBoolean("Structures." + structureList + ".Permission"), configLoad.getStringList("Structures." + structureList + ".Description")));
			}	
		}
	}
	
	public void addStructure(String name, Materials materials, String fileName, String displayName, boolean permission, List<String> description) {
