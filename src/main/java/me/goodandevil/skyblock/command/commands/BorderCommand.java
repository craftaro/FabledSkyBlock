...
public class BorderCommand extends SubCommand {
	...
	public void onCommandByPlayer(Player player, String[] args) {
		...
		if (islandManager.hasIsland(player)) {
			...
			if ((island.hasRole(IslandRole.Operator, player.getUniqueId()) && island.getSetting(IslandRole.Operator, "Border").getStatus()) || island.hasRole(IslandRole.Owner, player.getUniqueId())) {
